...
export default function Navbar({ dark, setDark }) {
  ...
  return (
    <nav className="bg-primary text-white fixed top-0 left-0 w-full z-50 shadow-md overflow-x-hidden">
      ...
      {/* Menu Mobile */}
      {menuOpen && (
        <div className="md:hidden bg-primary text-center py-4 space-y-4 w-full">
